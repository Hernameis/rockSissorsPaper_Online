...
public class RankingPanel extends Panel{
	...
	public RankingPanel() {
		...
		titlePanel.add(new Label("순위"));
		titlePanel.add(new Label("점수"));
		titlePanel.add(new Label("이름"));
		titlePanel.add(new Label("승"));
		titlePanel.add(new Label("무"));
		titlePanel.add(new Label("패"));
		titlePanel.add(new Label("승률"));
		...
		myDataSet.add(new JLabel(""+(UserData.me.rank+1)));
