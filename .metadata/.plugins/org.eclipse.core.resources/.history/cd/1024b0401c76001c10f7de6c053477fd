...
public class LobbyPanel extends Panel{
	...
	public LobbyPanel() {
		...
		centerInfo.add(new Label("Á¡¼ö"));
		centerInfo.add(new Label("½Â"));
		centerInfo.add(new Label("¹«"));
		centerInfo.add(new Label("ÆÐ"));
		centerInfo.add(new Label("½Â·ü"));
		...
		goToStart=new ToStartPanelButton("Ã¹ È­¸é");
		exit=new ExitButton("°ÔÀÓ Á¾·á", frame);
